...
Public Class Test ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
...
<<<<<<< HEAD
    ...
    Public Property TeacherIDBoy() As String
        Get
            Return _TeacherIDBoy
        End Get
        Set(ByVal value As String)
            SetPropertyValue("TeacherIDBoy", _TeacherIDBoy, value)
        End Set
    End Property
